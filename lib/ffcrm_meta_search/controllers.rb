ActiveSupport.on_load :action_controller do
  ...
  %w(AccountsController CampaignsController ContactsController LeadsController OpportunitiesController TasksController).each do |controller_name|

    controller = controller_name.constantize
    controller.class_eval do

      skip_before_action :require_user, only: :meta_search
